...
class AttendanceService:
    ...
    def seed_attendance_for_planned_lesson(self, lesson_id: str, group_id: str) -> None:
    ...
    def add_attendance_for_new_member(self, group_id: str, member_id: str) -> None:
        planned_lessons = self.lesson_repository.list_by_group_and_status(group_id, "planned")
