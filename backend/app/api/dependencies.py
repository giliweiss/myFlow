...
def get_instructor_exercise_repository() -> InstructorExerciseRepository:
    return InstructorExerciseRepository(get_supabase_client())
...
def get_lesson_generator_service() -> LessonGeneratorService:
